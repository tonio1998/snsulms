...
// const HOST_DOMAIN = 'fruis.snsu.edu.ph';
...
export const APP_NAME = "fbLearn";
export const TAGLINE = "For inclusive growth, empowered lives, and a service-focused future"
