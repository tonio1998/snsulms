...
const getCacheKeys = (userId) => ({
    CACHE_KEY: `fac_classes_cache_${userId}`,
    CACHE_DATE_KEY: `fac_classes_cache_date_${userId}`,
});
export const saveFacClassesToLocal = async (userId, data) => {
...
export const loadFacClassesFromLocal = async (userId) => {
