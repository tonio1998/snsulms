...
const getCacheKeys = (userId) => ({
    CACHE_KEY: `enrollment_classes_cache_${userId}`,
    CACHE_DATE_KEY: `enrollment_classes_cache_date_${userId}`,
});
export const saveEnrollmentClassesToLocal = async (userId, data) => {
...
export const loadEnrollmentClassesToLocal = async (userId) => {
