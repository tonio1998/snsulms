...
const getCacheKeys = (userId) => ({
    CACHE_KEY: `all_activities_cache_${userId}`,
    CACHE_DATE_KEY: `all_activities_cache_date_${userId}`,
});

export const saveAllStudentActivitiesToLocal = async (userId, data) => {
...
export const loadAllStudentActivitiesToLocal = async (userId) => {
